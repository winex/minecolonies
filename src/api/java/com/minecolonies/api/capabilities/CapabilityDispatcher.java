...
public class CapabilityDispatcher implements ICapabilitySerializable<NBTTagCompound>
{
    ...
    public static void attach(AttachCapabilitiesEvent<ItemStack> event)
    {
        ...
        if (event.getCapabilities().containsKey(new ResourceLocation(Constants.MOD_ID.toLowerCase(), Constants.CAPABILITY_DEFAULT)))
        {
            return;
        }

        event.addCapability(new ResourceLocation(Constants.MOD_ID.toLowerCase(), Constants.CAPABILITY_DEFAULT), new CapabilityDispatcher());
    }
    ...
    public interface IInstanceCap
    {
        ...
        class Impl implements IInstanceCap
        {
            ...
            public Impl(CapabilityDispatcher dispatcher)
            {
    ...
    public static class RegistrationController
    {
        ...
        {
            CapabilityDispatcher.attach(event);
        }
    }
    ...
    private class SerializationBiConsumer<T> implements BiConsumer<Capability<T>, T>
    {
        ...
        {
            System.out.println("Capability: " + tCapability);
            System.out.println("T: " + t);
            System.out.println("INSTANCE_CAPABILITY: " + INSTANCE_CAPABILITY);
