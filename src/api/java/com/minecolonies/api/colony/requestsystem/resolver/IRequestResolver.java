...
public interface IRequestResolver<R extends IRequestable> extends IRequester
{
     ...
     */
    @Nullable
    IToken<?> getFollowupRequestForCompletion(@NotNull IRequestManager manager, @NotNull IRequest<? extends R> completedRequest);
     ...
     */
    @Nullable
    IToken<?> onRequestCancelled(@NotNull IRequestManager manager, @NotNull IRequest<? extends R> request);
