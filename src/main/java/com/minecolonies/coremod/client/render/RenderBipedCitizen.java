...
public class RenderBipedCitizen extends RenderBiped<EntityCitizen>
{
    ...
    {
        super(renderManagerIn, defaultModelMale, SHADOW_SIZE);
    ...
    @Override
    protected boolean bindEntityTexture(EntityCitizen entity)
    {
    	return CitizenTextures.bindTexture(entity.getModelID(), entity.isFemale(), entity.getTextureId());
    }
