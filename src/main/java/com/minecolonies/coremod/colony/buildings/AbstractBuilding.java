...
public abstract class AbstractBuilding implements IRequestResolverProvider, ICapabilityProvider
{
    ...
    private int height;
    /**
     * Token for the request resolver provider
     */
    private IToken<?> requestResolverProviderToken;
    ...
    {
        location = pos;
        this.requestResolverProviderToken = StandardFactoryController.getInstance().getNewInstance(TypeConstants.STANDARDTOKEN);
        this.colony = colony;
    }
    ...
    public void readFromNBT(@NotNull final NBTTagCompound compound)
    {
        ...
        if (compound.hasKey(TAG_REQUEST_RESOLVER_ID))
        {
            this.requestResolverProviderToken = StandardFactoryController.getInstance().deserialize(compound.getCompoundTag(TAG_REQUEST_RESOLVER_ID));
        }
    ...
    public void writeToNBT(@NotNull final NBTTagCompound compound)
    {
        ...
        compound.setTag(TAG_REQUEST_RESOLVER_ID, StandardFactoryController.getInstance().serialize(this.requestResolverProviderToken));
    }
    ...
    {
        return requestResolverProviderToken;
    }

    @Override
    public ImmutableCollection<IRequestResolver<?>> getResolvers()
    {
        return ImmutableList.of(new BuildingRequestResolver(
          StandardFactoryController.getInstance().getNewInstance(TypeConstants.ILOCATION, getLocation(), getColony().getWorld().provider.getDimension()),
          getColony().getRequestManager().getFactoryController().getNewInstance(
